...
namespace DevCore.ArtToolset.Editors {
    ...
    public class GradientAtlasEditor : GeneratedTextureEditor {
        ...
        private SerializedProperty m_StackFromTopProp = null;
        ...
        protected override void FindProperties() {
            ...
            m_StackFromTopProp = serializedObject.FindProperty("m_StackFromTop");
        }

        protected override void DrawInspector() {
            if (m_IsAtlastTooSmall) {
                EditorGUILayout.HelpBox("Your atlas resolution is too small to generate all textures. " +
                    "You must create another atlas or increase the resolution of this one", MessageType.Warning);
            }
            ...
            EditorGUILayout.PropertyField(m_StackFromTopProp); 
