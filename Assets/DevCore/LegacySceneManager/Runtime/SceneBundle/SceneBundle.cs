...
namespace DevCore.SceneManagement.Legacy {
	...
	/// </summary>
	[CreateAssetMenu(menuName = Constants.ASSET_PATH +"Scenes/Scene Bundle", fileName = "NewSceneBundle", order = 50)]
	public class SceneBundle : ScriptableObject {
		...
		/// </summary>
		public void LoadAsync(LoadingCallback onLoadingEnd = null) {
			EnhancedSceneManager.LoadSceneBundleAsync(this, onLoadingEnd);
		}
        #endregion
